...
filepath = 'C:/Users/HP/Desktop/capiston/CSE-498/Plant-Leaf-Disease-Prediction-main/Classification_model.h5'
...
@app.route("/want_to_know_more", methods=['GET', 'POST'])
def more():
        return render_template('want_to_know_more.html')
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('C:/Users/HP/Desktop/capiston/CSE-498/Plant-Leaf-Disease-Prediction-main/static/upload/', filename)
        file.save(file_path)
